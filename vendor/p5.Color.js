// TODO remove the whole thing, this is an quite too much overhead.
//     Still would like to try out HSL color lerping
...
const color_conversion = ColorConversion;
 ...
 *                                          or CSS color.
 *
 * @param {'RGB'|'HSL'|'HSB'} colorMode
 */
class Color {
  constructor(vals, colorMode) {
    // Record color mode and maxes at time of construction.
    this._storeModeAndMaxes(colorMode, _colorMaxes);
