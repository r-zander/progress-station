...
const modules = {
    ...
    Furnace: new Module({
        ...
        requirements: [
            new AttributeRequirement('playthrough', [{attribute: attributes.gridStrength, requirement: 4}]),
            new PointOfInterestVisitedRequirement('playthrough', [{pointOfInterest: pointsOfInterest.StarlightEnclave}]),
        ],
    }),
